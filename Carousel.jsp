...
<div id="myCarousel" class="carousel slide" data-ride="carousel"><!--Carousel starts from here-->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<c:url value="resources/images/Men.jpg"></c:url>" alt="Men's Clothing">
    ...
    <div class="item">
      <img src="<c:url value="resources/images/Girl.jpg"></c:url>" alt="Girls Clothing">
       <div class="carousel-caption">
        <h3>Girls Wearing</h3>
    ...
    <div class="item">
      <img src="<c:url value="resources/images/Car.jpg"></c:url>" alt="Electronics Things">
       <div class="carousel-caption">
        <h3>Technology </h3>
    ...
    <div class="item">
      <img src="<c:url value="resources/images/Furniture.jpg"></c:url>" alt="Furniture">
       <div class="carousel-caption">
        <h3>Furniture</h3>
